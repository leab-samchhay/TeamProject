        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between border-bottom border-light">
                    <h4 class="header-title">Manage Supplier</h4>
                    <div>
                        <a href="{{ route('supplier.create') }}" class="btn btn-success bg-gradient"><i
                            class="ti ti-plus me-1"></i> Add Supplier</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pe-3">
                                            <div class="hstack gap-1 justify-content-end">
                                                ...
                                                <form action="{{ route('supplier.remove', $row->id) }}" method="POST"

@extends('layouts.app')
@section('title', 'PurchaseDetail')
@section('content')
    <div class="row my-2">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between border-bottom border-light">
                    <h4 class="header-title">Manage PurchaseDetail</h4>
                    <div>
                        <a href="{{ route('purchaseDetail.create') }}" class="btn btn-success bg-gradient"><i
                            class="ti ti-plus me-1"></i> Add PurchaseDetail</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pe-3">
                                            <div class="hstack gap-1 justify-content-end">
                                                ...
                                                <a href="{{ route('purchaseDetail.edit',$row->id) }}"
                                                    class="btn btn-soft-success btn-icon btn-sm rounded-circle"> <i
                                                        class="ti ti-edit fs-16"></i></a>

                                                <form action="{{ route('purchaseDetail.remove', $row->id) }}" method="POST"

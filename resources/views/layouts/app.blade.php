...
<!-- Mirrored from coderthemes.com/osen/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Dec 2025 02:30:23 GMT -->
                    ...
                    <div class="topbar-item nav-user">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item active fw-semibold text-danger" href="{{ route('logout') }}"
                                    ...
                                    <span class="d-flex h-100">
                                        <span class="flex-shrink-0">
                                            <span class="bg-light d-flex h-100 border-end flex-column p-1 px-2">
                                                ...
                                                <span
                                                    class="d-block border-2 border-secondary border-opacity-25 rounded w-100 mb-1"></span>
                                                <span
                                                    class="d-block border-2 border-secondary border-opacity-25 rounded w-100 mb-1"></span>
                                                <span
                                                    class="d-block border-2 border-secondary border-opacity-25 rounded w-100 mb-1"></span>
                                ...
                                <div>
                                    <span class="d-flex h-100 flex-column">
                                        <span
                                            ...
                                            <span
                                                class="d-block border-2 border-secondary border-opacity-25 rounded ms-auto"></span>
                                            <span
                                                class="d-block border-2 border-secondary border-opacity-25 rounded ms-1"></span>
                                            <span
                                                class="d-block border-2 border-secondary border-opacity-25 rounded ms-1"></span>
                                            <span
                                                class="d-block border-2 border-secondary border-opacity-25 rounded ms-1"></span>
                                        ...
                                        <span class="flex-shrink-0">
                                            <span class="bg-light d-flex h-100 flex-column p-1 px-2">
                                                ...
                                                <span
                                                    class="d-block border-2 border-secondary border-opacity-25 rounded w-100 mb-1"></span>
                                                <span
                                                    class="d-block border-2 border-secondary border-opacity-25 rounded w-100"></span>
                                            </span>
                                        </span>
                                    </span>

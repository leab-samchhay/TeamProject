        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header d-flex align-items-center justify-content-between border-bottom border-light">
                    <h4 class="header-title">Manage Unitype</h4>

                    <div>
                        <a href="{{ route('unitype.create') }}" class="btn btn-success bg-gradient">
                            <i class="ti ti-plus me-1"></i> Add Unitype
                        </a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="hstack gap-1 justify-content-center">
                                                <a href="{{ route('unitype.edit',$row->id) }}"
                                                    class="btn btn-soft-success btn-icon btn-sm rounded-circle">
                                                    <i class="ti ti-edit fs-16"></i>
                                                </a>
                                                <form action="{{ route('unitype.remove', $row->id) }}"
                                                    method="POST"

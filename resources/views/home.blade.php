                            ...
                            <div class="row g-2 mb-0 align-items-center">
                                ...
                                <div class="col-sm-auto">
                                    <div class="input-group">
                                        <input type="text" class="form-control border-0 shadow" data-provider="flatpickr"
        ...
        <div class="row">
            <div class="col">
                <div class="row row-cols-xxl-4 row-cols-md-2 row-cols-1 text-center">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted fs-13 text-uppercase" title="Number of Orders">Total
                                    Orders</h5>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted fs-13 text-uppercase" title="Number of Orders">Avg.
                                    Sales Earnings</h5>
                                <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                    <div class="user-img fs-42 flex-shrink-0">
                                        <span class="avatar-title text-bg-primary rounded-circle fs-22">
                                    ...
                                    <h3 class="mb-0 fw-bold">$98.24 <small class="text-muted">USD</small>
                                    </h3>
                                </div>
                                <p class="mb-0 text-muted">
                                    <span class="text-success me-2"><i class="ti ti-caret-up-filled"></i>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted fs-13 text-uppercase" title="Number of Orders">Number
                                    of Visits</h5>
                                <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                    <div class="user-img fs-42 flex-shrink-0">
                                        <span class="avatar-title text-bg-primary rounded-circle fs-22">
                            ...
                            <div class="card-body pt-0">
                                <div dir="ltr">
                                    <div id="revenue-chart" class="apex-charts"
                                        data-colors="#6ac75a,#465dff,#783bff,#f7577e"></div>
                                </div>
                            </div>
                        </div> <!-- end card-->
                    </div> <!-- end col-->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="multiple-radialbar" class="apex-charts"
                                    data-colors="#465dff,#6ac75a,#783bff,#f7577e"></div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <span class="text-muted fs-12">Clothing</span>
                                                            <br />
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <span class="text-muted fs-12">Lifestyle</span>
                                                            <br />
            ...
            <div class="col-auto info-sidebar">
                <div class="alert alert-primary d-flex align-items-center">
                    <iconify-icon icon="solar:help-bold-duotone" class="fs-24 me-1"></iconify-icon> <b>Help
                        line:</b> <span class="fw-medium ms-1">+(012) 123 456 78</span>
                </div>
                ...
                <div class="card bg-primary">
                    <div class="card-body"
                        ...
                        <p class="text-white text-opacity-75">We kindly encourage you to review your recent
                            transactions</p>

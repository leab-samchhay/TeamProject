                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="MethodID" class="form-select">
                                        ...
                                        @foreach ($paymentMethods as $method)
                                            <option value="{{ $method->id }}" {{ old('MethodID', $payment->MethodID) == $method->id ? 'selected' : '' }}>
                                                {{ $method->MethodName }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="InvoiceID" class="form-select">
                                        ...
                                        @foreach ($invoices as $invoice)
                                            <option value="{{ $invoice->id }}" {{ old('InvoiceID', $payment->InvoiceID) == $invoice->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        name="TotalPayment"
                                        class="form-control"
                                        value="{{ old('TotalPayment', $payment->TotalPayment) }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date"
                                        name="PaymentDate"
                                        class="form-control"
                                        value="{{ old('PaymentDate', $payment->PaymentDate ? $payment->PaymentDate->format('Y-m-d') : '') }}">

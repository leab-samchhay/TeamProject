        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between border-bottom border-light">
                    ...
                    <div>
                        <a href="{{ route('category.create') }}" class="btn btn-success bg-gradient"><i
                            class="ti ti-plus me-1"></i> Add Category</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pe-3">
                                            <div class="hstack gap-1 justify-content-end">
                                                ...
                                                <form action="{{ route('category.remove', $row->id) }}" method="POST"

                           ...
                           <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="supplierId" class="form-select">
                                        ...
                                        @foreach ($suppliers as $supplier)
                                            <option value="{{ $supplier->id }}" {{ old('supplierId',$purchase->supplierId) == $supplier->id ? 'selected' : '' }}>
                                                {{ $supplier->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="userId" class="form-select">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" {{ old('userId',$purchase->userId) == $user->id ? 'selected' : '' }}>
                                                {{ $user->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        name="totalAmount"
                                        class="form-control"
                                        value="{{ old('totalAmount',$purchase->totalAmount) }}">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select name="status" class="form-select">
                                        <option value="1" {{ old('status',$purchase->status) == 1 ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ old('status',$purchase->status) == 0 ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                </div>
